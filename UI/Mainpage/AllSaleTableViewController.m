...
@interface AllSaleTableViewController () {
...
@implementation AllSaleTableViewController
...
- (void)viewDidLoad
{
    ...
    [HTTPRequestEnding getSaleComplete:^(NSMutableArray *specialArray) {
        self.specialArray = specialArray;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Special *special = [self.specialArray objectAtIndex:indexPath.row];
